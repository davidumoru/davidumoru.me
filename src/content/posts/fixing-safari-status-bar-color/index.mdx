...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: var(--space-md);">
  <Figure src={mismatchLight} alt="Light mode page with dark status bar" />
  <Figure src={mismatchDark} alt="Dark mode page with light status bar" />
</div>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: var(--space-md);">
  <Figure
    src={matchLight}
    alt="Light mode page with matching light status bar"
  />
  <Figure src={matchDark} alt="Dark mode page with matching dark status bar" />
</div>
