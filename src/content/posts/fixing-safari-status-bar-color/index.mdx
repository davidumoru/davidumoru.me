...
<Picture
  ...
  imgAlt={["Light mode page with dark status bar", "Dark mode page with light status bar"]}
  variant="grid"
  columns={2}
/>
...
<Picture
  ...
  imgAlt={["Light mode page with matching light status bar", "Dark mode page with matching dark status bar"]}
  variant="grid"
  columns={2}
/>
